...
Any linux distro should work. However, we recommend running Ubuntu 16.04 LTS, since all scripts
...
## My machine is Mac or Windows with 8GB+ of memory
...
Ubuntu VM images can be downloaded here:
 ...
 http://www.osboxes.org/ubuntu-16-04-3-images-available-virtualbox-vmware/
